...
test("V1.5.18 keeps one avatar camera baseline, exposes the version, and packages only active station skills", async () => {
  ...
  assert.match(packageSource, /"version": "1\.5\.18"/);
  assert.match(packageSource, /"productName": "小安站点咨询顾问 V1\.5\.18"/);
  ...
  assert.match(indexSource, /<title>小安站点咨询顾问 V1\.5\.18<\/title>/);
